...
public class ProductPageTest extends BaseClass  {
	...
	public ProductPageTest() throws FileNotFoundException {
	}
	...
	{   driver.get(url);
		...
		signUpOrLoginPage pg = new signUpOrLoginPage(driver);
		pg.enterRegisteredEmailAddress(emailAddress);

		logger.info("User Email and Password entered.");
		pg.enterRegisteredPassword(password);

		pg.clickSignInButton();
		logger.info("Sign In link clicked");

		//Enter searchkey in search box
		myAccountPage productPg = new myAccountPage(driver);
	...
	public void VerifyBuyProduct() throws IOException
	{
		...
		myAccountPage prodCatPg = new myAccountPage(driver);
